...
sys.path.insert(0, str(Path("repositories/GPTQ_for_LLaMa")))
from repositories.GPTQ_for_LLaMa.modelutils import find_layers
from repositories.GPTQ_for_LLaMa.quant import make_quant
